...
protected void itemSelected(object sender, EventArgs e)
    ...
    public void EventRedirect(object sender, EventArgs e)
    {
    ...
    public void Event_NotesRedirect(object sender, EventArgs e)
    {
        Response.Redirect("Event_Notes.aspx?id=" + Request.QueryString["id"]);
    }
    public void ReviewRedirect(object sender, EventArgs e)
    {
        Response.Redirect("Review.aspx?id=" + Request.QueryString["id"]);
    }
